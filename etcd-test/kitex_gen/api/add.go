...
type AddRequest struct {
	First  int32 `thrift:"first,1" frugal:"1,default,i32" json:"first"`
	Second int32 `thrift:"second,2" frugal:"2,default,i32" json:"second"`
}
...
func (p *AddRequest) GetFirst() (v int32) {
	return p.First
}

func (p *AddRequest) GetSecond() (v int32) {
	return p.Second
}
func (p *AddRequest) SetFirst(val int32) {
	p.First = val
}
func (p *AddRequest) SetSecond(val int32) {
	p.Second = val
}
...
func (p *AddRequest) writeField1(oprot thrift.TProtocol) (err error) {
	...
	if err := oprot.WriteI32(p.First); err != nil {
		return err
	}
...
func (p *AddRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("second", thrift.I32, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.Second); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *AddRequest) Field2DeepEqual(src int32) bool {
...
func (p *AddResponse) GetSum() (v int32) {
	return p.Sum
}
func (p *AddResponse) SetSum(val int32) {
	p.Sum = val
}
...
func (p *AddResponse) Field1DeepEqual(src int32) bool {
